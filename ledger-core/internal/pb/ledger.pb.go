...
const file_ledger_proto_rawDesc = "" +
	...
	"\aentries\x18\x01 \x03(\v2\x18.ledger.TransactionEntryR\aentries2\xe1\x01\n" +
	"\rLedgerService\x12D\n" +
	...
	"\x11GetAccountHistory\x12\x16.ledger.HistoryRequest\x1a\x17.ledger.HistoryResponseBL\n" +
...
var file_ledger_proto_depIdxs = []int32{
	...
	1, // 4: ledger.LedgerService.ExecuteTransfer:output_type -> ledger.TransferResponse
	3, // 5: ledger.LedgerService.GetAccountBalance:output_type -> ledger.BalanceResponse
	6, // 6: ledger.LedgerService.GetAccountHistory:output_type -> ledger.HistoryResponse
