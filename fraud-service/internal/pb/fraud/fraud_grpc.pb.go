...
const (
	FraudService_CheckTransfer_FullMethodName = "/fraud.FraudService/CheckTransfer"
)
...
type FraudServiceClient interface {
	CheckTransfer(ctx context.Context, in *FraudCheckRequest, opts ...grpc.CallOption) (*FraudCheckResponse, error)
}
...
func (c *fraudServiceClient) CheckTransfer(ctx context.Context, in *FraudCheckRequest, opts ...grpc.CallOption) (*FraudCheckResponse, error) {
...
type FraudServiceServer interface {
	CheckTransfer(context.Context, *FraudCheckRequest) (*FraudCheckResponse, error)
...
func (UnimplementedFraudServiceServer) CheckTransfer(context.Context, *FraudCheckRequest) (*FraudCheckResponse, error) {
...
func _FraudService_CheckTransfer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FraudServiceServer).CheckTransfer(ctx, req.(*FraudCheckRequest))
	}
